...
export default function Home() {
    ...
    function handleSubmit(e) {
        ...
        axios.post("http://https://hospital-applications-9rr4.onrender.com/api/appointments/add", newAppointment)
            .then((res) => {
                console.log(res)
                if(res.status===201){
    ...
    async function fetchDoctors() {
        await axios.get("http://https://hospital-applications-9rr4.onrender.com/api/doctors")
            .then((res) => {
